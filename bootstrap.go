...
func main() {
	...
	engine.GET("/getArticle/:customerId", routes.GetArticleByPrimaryKey)
	...
	engine.GET("/getAuth/:customerId", routes.GetAuthByPrimaryKey)
	...
	engine.GET("/getMsg/:customerId", routes.GetMsgByPrimaryKey)
	...
	engine.GET("/getTag/:customerId", routes.GetTagByPrimaryKey)
